...
export function MemberFormModalTabbed({
  open,
  onClose,
  onSubmit,
  member,
  ...
  useEffect(() => {
    if (mode === 'edit' && member) {
      setFormData({
        ...
        sk_pensiun: member.sk_pensiun || 'ada',
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
            {/* Tabs Header */}
            <TabsList className="shrink-0 grid grid-cols-5 w-full h-auto p-1 bg-muted">
              <TabsTrigger value="basic" className="flex items-center gap-2">
                <User className="h-4 w-4" />
                <span className="hidden sm:inline">Data Dasar</span>
              </TabsTrigger>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-6">
                ...
                <TabsContent value="basic" className="mt-0 space-y-6">
                  ...
                  <div>
                    <h3 className="text-md font-semibold mb-4">Informasi Pribadi</h3>
                ...
                <TabsContent value="financial" className="mt-0 space-y-6">
                  ...
                  {/* BPJS */}
                  <div>
                    <h3 className="text-md font-semibold mb-4">Data BPJS</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                ...
                <TabsContent value="advanced" className="mt-0 space-y-6">
                  {/* Bantuan Sosial */}
                  <div>
                    <h3 className="text-md font-semibold mb-4">Bantuan Sosial</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                  ...
                  {/* Data Mutasi */}
                  <div>
                    <h3 className="text-md font-semibold mb-4">Data Mutasi</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                  ...
                  {/* Datul */}
                  <div>
                    <h3 className="text-md font-semibold mb-4">Datul</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
